import{_ as s,o as n,c as a,a as l}from"./app.c7558d4a.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":3,"title":"消费端配置","slug":"消费端配置","link":"#消费端配置","children":[]}],"relativePath":"api/sub.md","lastUpdated":1692797655000}'),p={name:"api/sub.md"},o=l(`<h3 id="消费端配置" tabindex="-1">消费端配置 <a class="header-anchor" href="#消费端配置" aria-hidden="true">#</a></h3><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#C792EA;">interface</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">SubConfig</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
